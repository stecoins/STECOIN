Contributing to SATELLITE Core
==================================

The SATELLITE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SATELLITE Core project, and is not to be
confused with overall SATELLITE Network Protocol consensus changes.

Whether a pull request is merged into SATELLITE Core rests with the project merge
...
Patches that change SATELLITE consensus rules are considerably more involved than
...
Where a patch set proposes to change the SATELLITE consensus, it must have been
...
The project leader is the release manager for each SATELLITE Core release.
