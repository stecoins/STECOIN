...
#   c) node1 mines 32 blocks, so now node 0 has 500000STE, node 1 has 4250STE, node2 has none.
#   d) node0 sends 601 STE to node2, in two transactions (301 STE, then 300 STE).
