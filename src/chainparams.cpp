...
// Copyright (c) 2017 The SATELLITE developers
...
(0, uint256("000007e46b73d1c879cc0ca775226a558dae84e328638eb77dccdfd0532afd5f"));
	 
	

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1552812731, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 60; // SATELLITE: 
        nTargetSpacing = 1 * 60;  // SATELLITE:  
        nMaturity = 50;
        ...
        nLastPOWBlock = 1000;
        nModifierUpdateBlock = 1; // we use the version 2 for STE

		const char* pszTimestamp = "This Is Unique WORLD FOR Coin Develop at 19 March 2019";
        ...
        genesis.nVersion = 1;
		genesis.nTime = 1552812731;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1548834;

         
		 
		hashGenesisBlock = genesis.GetHash();
		assert(hashGenesisBlock == uint256("0x000007e46b73d1c879cc0ca775226a558dae84e328638eb77dccdfd0532afd5f"));
		assert(genesis.hashMerkleRoot == uint256("0x064ca29b8a6783af07a6e153cc55cdd3828e1c64029960c213d23a18cd068f1c"));
        ...
        // SATELLITE BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // SATELLITE BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // SATELLITE BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // SATELLITE: 1 day
        nTargetSpacing = 2 * 60;  // SATELLITE: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
      ...
      //  vSeeds.push_back(CDNSSeedData("159.89.119.230", "159.89.119.230"));
        ...
        // Testnet SATELLITE addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet SATELLITE script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet SATELLITE BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet SATELLITE BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // SATELLITE: 1 day
        nTargetSpacing = 2 * 60;        // SATELLITE: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
