...
/** Fees smaller than this (in uSTE) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0)
		...
		nSubsidy = 1 * COIN;
	else if (nHeight > 10001 && nHeight <= 500000000)
		nSubsidy = 20 * COIN;
	else if (nHeight > 500000001 && nHeight <= 600000000)
		nSubsidy = 19 * COIN;
	else if (nHeight > 600000001 && nHeight <= 700000000)
		nSubsidy = 18 * COIN;
	else if (nHeight > 700000001 && nHeight <= 800000000)
		nSubsidy = 17 * COIN;
	else if (nHeight > 800000001 && nHeight <= 900000000)
		nSubsidy = 16 * COIN;
	else if (nHeight > 900000001 && nHeight <= 1000000000)
		nSubsidy = 15 * COIN;
	else
		nSubsidy = 1 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // STE: We use certain sporks during IBD, so check to see if they are
