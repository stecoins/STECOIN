...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SATELLITE features */
        {"SATELLITE", "masternode", &masternode, true, true, false},
        {"SATELLITE", "listmasternodes", &listmasternodes, true, true, false},
        {"SATELLITE", "getmasternodecount", &getmasternodecount, true, true, false},
        {"SATELLITE", "masternodeconnect", &masternodeconnect, true, true, false},
        {"SATELLITE", "masternodecurrent", &masternodecurrent, true, true, false},
        {"SATELLITE", "masternodedebug", &masternodedebug, true, true, false},
        {"SATELLITE", "startmasternode", &startmasternode, true, true, false},
        {"SATELLITE", "createmasternodekey", &createmasternodekey, true, true, false},
        {"SATELLITE", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"SATELLITE", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"SATELLITE", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"SATELLITE", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"SATELLITE", "getmasternodescores", &getmasternodescores, true, true, false},
        {"SATELLITE", "mnbudget", &mnbudget, true, true, false},
        {"SATELLITE", "preparebudget", &preparebudget, true, true, false},
        {"SATELLITE", "submitbudget", &submitbudget, true, true, false},
        {"SATELLITE", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"SATELLITE", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"SATELLITE", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"SATELLITE", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"SATELLITE", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"SATELLITE", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"SATELLITE", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"SATELLITE", "checkbudgets", &checkbudgets, true, true, false},
        {"SATELLITE", "mnsync", &mnsync, true, true, false},
        {"SATELLITE", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33230/\n";
}
