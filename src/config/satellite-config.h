/* src/config/satellite-config.h.  Generated from satellite-config.h.in by configure.  */
/* src/config/satellite-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "SATELLITE Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SATELLITE Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "satellite"
