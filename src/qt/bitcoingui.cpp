                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SATELLITE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STE address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SATELLITE Core"), this);
    aboutAction->setStatusTip(tr("Show information about SATELLITE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SATELLITE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STE addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SATELLITE Core help message to get a list with possible SATELLITE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SATELLITE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SATELLITE network", "", count));
}
...
{
    QString strTitle = tr("SATELLITE Core"); // default title
