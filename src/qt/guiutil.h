...
/** Utility functions used by the STEcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render STE addresses in monospace font
...
// Parse "satellite:" URI into recipient object, return true on successful parsing
