...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SATELLITE Core"),
     ...
     * override -datadir in the satellite.conf file in the default data directory
     * (to be consistent with satellited behavior)
     */
    if (dataDir != getDefaultDataDirectory())
