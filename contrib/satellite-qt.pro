...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/satellite-cli.cpp \
           src/satellite-tx.cpp \
           src/satellite.cpp \
           src/db.cpp \
           ...
           src/qt/satellite.cpp \
           src/qt/satellitestrings.cpp \
...
RESOURCES += src/qt/satellite.qrc src/qt/satellite_locale.qrc

TRANSLATIONS += src/qt/locale/satellite_bg.ts \
                src/qt/locale/satellite_de.ts \
                src/qt/locale/satellite_en.ts \
                src/qt/locale/satellite_es.ts \
                src/qt/locale/satellite_fi.ts \
                src/qt/locale/satellite_fr.ts \
                src/qt/locale/satellite_it.ts \
                src/qt/locale/satellite_ja.ts \
                src/qt/locale/satellite_pl.ts \
                src/qt/locale/satellite_pt.ts \
                src/qt/locale/satellite_ru.ts \
                src/qt/locale/satellite_sk.ts \
                src/qt/locale/satellite_sv.ts \
                src/qt/locale/satellite_vi.ts \
                src/qt/locale/satellite_zh_CN.ts \
                src/qt/locale/satellite_zh_TW.ts
