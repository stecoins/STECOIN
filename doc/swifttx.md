...
This mechanism has been integrated into Bitcore-Node-STEcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/satellite/insight-api-satellite#web-socket-api](https://github.com/satellite/insight-api-satellite#web-socket-api)
* API: [https://github.com/satellite/insight-api-satellite#swifttx-transactions](https://github.com/satellite/insight-api-satellite#swifttx-transactions)
...
By default, the SATELLITE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SATELLITE Core daemon:
