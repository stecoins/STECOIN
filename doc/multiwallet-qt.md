...
In order to support loading of multiple wallets in satellite-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is satellite.cpp.
...
Changes to satellite.cpp
----------------------
satellite.cpp is the entry point into satellite-qt, and as such, will require some minor modifications to provide hooks for
